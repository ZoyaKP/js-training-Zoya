...
function manageShoppingList (shoppingList) {

shoppingList.push('Butter');
let removedItem = shoppingList.pop();
shoppingList.unshift('Juice');
let removedItem2 = shoppingList.shift();

return shoppingList;
}
console.log(manageShoppingList(shoppingList));
...
console.log(collectCharacters("Javascript training process"));
;
...
function getTotalEarnings() {
  return earnings.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
}
